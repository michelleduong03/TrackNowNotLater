      ...
      return (
        <>
          ...
          {filteredPayments.length > 0 && (
            ...
            >
              <h2 style={{ marginBottom: '1.2rem', color: '#2c3e50', fontSize: isMobile ? '1.5rem' : '2rem', fontWeight: 'bold', letterSpacing: '-0.03em', textAlign: 'center', width: '100%' }}>
                Total Owed: <span style={{ color: '#2563eb' }}>${totalOwed.toFixed(2)}</span>
              </h2>
              ...
              >
                <div style={{ flexShrink: 0, padding: '1rem', borderRadius: '12px', background: '#ffffff', boxShadow: '0 5px 15px rgba(0,0,0,0.06)', width: isMobile ? '100%' : '50%', minWidth: isMobile ? 'auto' : '350px', boxSizing: 'border-box' }}>
                  <ResponsiveContainer width="100%" height={isMobile ? 200 : 250}>
                    <PieChart>
                      ...
                      <Legend
                        iconType="circle"
                        wrapperStyle={{ paddingTop: '10px', fontSize: isMobile ? '0.75rem' : '0.85rem', whiteSpace: 'nowrap', textAlign: 'center' }}
