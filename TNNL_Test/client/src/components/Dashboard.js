      ...
      return (
        <>
          ...
          {filteredPayments.length > 0 && (
            ...
            >
              <h2 style={{ marginBottom: '1.2rem', color: '#2c3e50', fontSize: isMobile ? '1.5rem' : '2rem', fontWeight: 'bold', letterSpacing: '-0.03em', textAlign: 'center', width: '100%', fontFamily: 'Lora, serif', }}>
              ...
              >
                <div style={{ flexShrink: 0, padding: '1rem', borderRadius: '12px', background: '#ffffff', boxShadow: '0 5px 15px rgba(0,0,0,0.06)', width: isMobile ? '100%' : '50%', minWidth: isMobile ? 'auto' : '350px', boxSizing: 'border-box', fontFamily: 'Lora, serif', }}>
                  <ResponsiveContainer width="100%" height={isMobile ? 200 : 250}>
                    <PieChart>
                      ...
                      <Tooltip
                        ...
                        labelStyle={{ fontWeight: 'bold', color: '#333', fontFamily: 'Lora, serif', }}
                      />
                      <Legend
                        iconType="circle"
                        wrapperStyle={{ paddingTop: '10px', fontSize: isMobile ? '0.75rem' : '0.85rem', whiteSpace: 'nowrap', textAlign: 'center', fontFamily: 'Lora, serif', }}
                ...
                >
                  <h3 style={{ marginTop: 0, marginBottom: '1.5rem', color: '#2c3e50', fontSize: isMobile ? '1.2rem' : '1.5rem', fontWeight: '700', borderBottom: '1px solid #e0e0e0', paddingBottom: '0.8rem', textAlign: 'center' }}>Financial Overview</h3>
                  <div style={{ marginBottom: '0.9rem', display: 'flex', justifyContent: 'space-between', alignItems: 'center', fontSize: isMobile ? '0.9rem' : '1rem', padding: '0.3rem 0' }}>
                  ...
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', fontSize: isMobile ? '0.9rem' : '1rem', padding: '0.3rem 0' }}>
    ...
    >
      <nav
        style={{
          ...
          boxShadow: isMobile ? '0 2px 8px rgba(0,0,0,0.05)' : '2px 0 8px rgba(0,0,0,0.05)',
          ...
          right: 0,
          zIndex: 1000,
          borderTop: isMobile ? '1px solid #4a657e' : 'none',
        }}
      >
        {!isMobile && (
        ...
        <div
          ...
          style={{
            ...
            padding: isMobile ? '0.4rem 0.6rem' : '0.8rem 1.2rem',
          }}
        >
          Dashboard
        </div>
        ...
        <button
          ...
          style={{
            ...
            padding: isMobile ? '0.5rem 0.8rem' : '0.9rem 1.2rem',
